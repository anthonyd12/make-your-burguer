        ...
        <div>
            <form id="burguer-form" @submit="createBurguer">
                <div class="input-container">
                    ...
                    <input type="text" id="nome" name="nome" v-model="nome" placeholder="Type your name">
                </div>
                <div class="input-container">
                ...
                <div class="input-container">
                    <label for="carne">Choose your beef:</label>
                ...
                <div id="opcionais-container" class="input-container">
                    <label id="opcionais-title" for="opcionais">Select the options:</label>
